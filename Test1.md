...
::: block
### Réaliser une présentation {style=background:#FF8551;width:100%}
::: 

::: block
*Interactive * {style=background:#9BCDD2;color:red;width:500px}
::: 

::: block
*Web friendly | Portable* {style=background:#FF8551;width:500px}
:::

::: block
*100 % Free* {style=background:#FF8551;width:500px}
:::

---

// @[desmond de amil](https://ddeamil.github.io/e-format.github.io/)

---

### 🔶desmond de amil - IRP | FPA
